...
public class AAEItems {
    ...
    //            item("Walk Speed Card", "walk_speed_card", p -> new QuantumUpgradeBaseItem(UpgradeType.WALK_SPEED,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> SPRINT_SPEED_CARD = item(
    //            "Sprint Speed Card", "sprint_speed_card", p -> new QuantumUpgradeBaseItem(UpgradeType.SPRINT_SPEED,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> STEP_ASSIST_CARD =
    //            item("Step Assist Card", "step_assist_card", p -> new QuantumUpgradeBaseItem(UpgradeType.STEP_ASSIST,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> JUMP_HEIGHT_CARD =
    //            item("Jump Height Card", "jump_height_card", p -> new QuantumUpgradeBaseItem(UpgradeType.JUMP_HEIGHT,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> LAVA_IMMUNITY_CARD = item(
    //            "Lava Immunity Card", "lava_immunity_card", p -> new QuantumUpgradeBaseItem(UpgradeType.LAVA_IMMUNITY,
    // p));
    ...
    //            item("Auto Feeding Card", "auto_feeding_card", p -> new QuantumUpgradeBaseItem(UpgradeType.AUTO_FEED,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> AUTO_STOCK_CARD =
    //            item("Auto Stock Card", "auto_stock_card", p -> new QuantumUpgradeBaseItem(UpgradeType.AUTO_STOCK,
    // p));
    ...
    //            "Regeneration Card", "regeneration_card", p -> new QuantumUpgradeBaseItem(UpgradeType.REGENERATION,
    // p));
    ...
    //            "Attack Speed Card", "attack_speed_card", p -> new QuantumUpgradeBaseItem(UpgradeType.ATTACK_SPEED,
    // p));
    ...
    //            item("Swim Speed Card", "swim_speed_card", p -> new QuantumUpgradeBaseItem(UpgradeType.SWIM_SPEED,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> NIGHT_VISION_CARD = item(
    //            "Night Vision Card", "night_vision_card", p -> new QuantumUpgradeBaseItem(UpgradeType.NIGHT_VISION,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> FLIGHT_DRIFT_CARD = item(
    //            "Flight Drift Card", "flight_drift_card", p -> new QuantumUpgradeBaseItem(UpgradeType.FLIGHT_DRIFT,
    // p));
    //    public static final ItemDefinition<QuantumUpgradeBaseItem> RECHARGING_CARD =
    //            item("ME Recharging Card", "recharging_card", p -> new QuantumUpgradeBaseItem(UpgradeType.CHARGING,
    // p));
    ...
    //            item("Pick Craft Card", "pick_craft_card", p -> new QuantumUpgradeBaseItem(UpgradeType.PICK_CRAFT,
    // p));
