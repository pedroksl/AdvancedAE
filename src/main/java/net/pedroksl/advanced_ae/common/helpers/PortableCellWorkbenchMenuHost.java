...
public class PortableCellWorkbenchMenuHost extends ItemMenuHost<QuantumHelmet>
    ...
    public PortableCellWorkbenchMenuHost(QuantumHelmet item, Player player, ItemMenuHostLocator locator) {
