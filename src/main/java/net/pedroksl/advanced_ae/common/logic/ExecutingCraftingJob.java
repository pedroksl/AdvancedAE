...
public class ExecutingCraftingJob {
    ...
    ExecutingCraftingJob(ValueInput data, CraftingDifferenceListener postCraftingDifference, AdvCraftingCPULogic cpu) {
        this.link = new CraftingLink(data.childOrEmpty(NBT_LINK), cpu.cpu);
