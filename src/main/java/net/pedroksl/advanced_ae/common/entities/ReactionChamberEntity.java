...
public class ReactionChamberEntity extends AENetworkedPoweredBlockEntity implements IGridTickable,
	...
	public ReactionChamberEntity(BlockPos pos, BlockState blockState) {
		super(GlodUtil.getTileType(ReactionChamberEntity.class, ReactionChamberEntity::new, AAESingletons.REACTION_CHAMBER),
				pos,
				blockState);
