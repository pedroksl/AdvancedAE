...
public class AAESingletons {
	...
	public static void init(AAERegistryHandler handler) {
		...
		SMALL_ADV_PATTERN_PROVIDER_PART = new PartItem<>(new Item.Properties(), SmallAdvPatternProviderPart.class,
		...
		handler.block("small_adv_pattern_provider", SMALL_ADV_PATTERN_PROVIDER, SmallAdvPatternProviderEntity.class,
