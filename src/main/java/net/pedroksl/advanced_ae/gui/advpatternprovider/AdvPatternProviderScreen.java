...
public class AdvPatternProviderScreen<C extends AdvPatternProviderMenu> extends AEBaseScreen<AdvPatternProviderMenu> {
	...
	public AdvPatternProviderScreen(C menu, Inventory playerInventory, Component title,
	                                ScreenStyle style) {
